...
public class AdvancedSeitersonicExplosiveEntityPrimed extends Entity
{
    ...
    public AdvancedSeitersonicExplosiveEntityPrimed(World world1, double x, double y, double z, EntityLivingBase placingEntity, int explDir, int tier)
    {
    	this(world1);
    ...
    public AdvancedSeitersonicExplosiveEntityPrimed(World world1)
    {
        super(world1);
