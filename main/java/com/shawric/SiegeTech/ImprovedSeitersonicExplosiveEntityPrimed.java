...
public class ImprovedSeitersonicExplosiveEntityPrimed extends Entity
{
    ...
    public ImprovedSeitersonicExplosiveEntityPrimed(World world1, double x, double y, double z, EntityLivingBase placingEntity, int explDir, int tier)
    {
    	this(world1);
    ...
    public ImprovedSeitersonicExplosiveEntityPrimed(World world1)
    {
        super(world1);
